...
// src/components/modals/ConfirmRestoreModal.jsx
import React from "react";
import { RotateCcw, X, FileText, CheckCircle, AlertCircle, Sparkles } from "lucide-react";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl w-full max-w-lg shadow-2xl 
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-green-500/10 to-emerald-500/10 
                            rounded-full blur-3xl" />
            <div className="relative flex gap-3 p-4 bg-gradient-to-r from-green-50 to-emerald-50 
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    This document will be restored to its original location
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center justify-center py-3">
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2 px-3 py-1.5 bg-red-50 rounded-lg border border-red-200">
                ...
                <span className="text-xs font-medium text-red-700">Recycle Bin</span>
              </div>
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 bg-green-50 rounded-lg border border-green-200">
                ...
                <span className="text-xs font-medium text-green-700">Active Files</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-4 border border-gray-200">
            ...
            <div className="space-y-2">
              <div className="flex items-start gap-2">
                ...
                <p className="text-xs text-gray-600">Document will be fully accessible</p>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                <p className="text-xs text-gray-600">All permissions will be restored</p>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                <p className="text-xs text-gray-600">Document history will be preserved</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <Sparkles className="w-3 h-3 absolute right-2 top-1 text-yellow-300 
