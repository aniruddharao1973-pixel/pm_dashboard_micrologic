...
//         className={`
//           fixed top-0 left-0 h-full
//           w-56 sm:w-60 md:w-64 lg:w-68 xl:w-72 
...
//               handleClose();
//             }}
//             className="xl:hidden absolute top-3 right-3 sm:top-4 sm:right-4 bg-white/30 text-white p-1.5 sm:p-2 rounded-lg backdrop-blur-sm border border-white/30 hover:bg-white/40 active:scale-95 transition-all z-[120]"
//             aria-label="Close sidebar"
//           >
//             ✕
//           </button>
...
//           </div>
//           <div>
//             <h2 className="text-sm sm:text-base md:text-lg font-semibold text-white tracking-tight">PM Dashboard</h2>
//             <p className="text-[10px] sm:text-xs text-white/70 font-medium">Project Manager</p>
//           </div>
//         </div>
...
//               <div className="flex items-center gap-2 sm:gap-2.5 md:gap-3 relative z-30 pointer-events-auto">
//                 <span className="text-sm sm:text-base md:text-lg opacity-90">{item.icon}</span>
//                 <span className="font-medium text-xs sm:text-sm tracking-wide">{item.name}</span>
//               </div>

//               <div className={`h-1.5 w-1.5 sm:h-2 sm:w-2 rounded-full ${item.dotColor} opacity-80 group-hover:scale-125 transition-transform duration-300`} />
//             </NavLink>
//           ))}
//         </nav>
