...
//   const [notesFile, setNotesFile] = useState(null);   // ← ADD THIS
...
//     // merge approval_status → status
//     const docs = (docsRes.data || []).map((doc) => ({
//       ...doc,
//       // if backend added approval_status, prefer that
...
//         <div>
//           <h1 className="text-3xl font-bold text-gray-800">Folder Contents</h1>
//           {/* <p className="text-gray-600 mt-1">View subfolders and documents.</p> */}
//         </div>
...
//       {/* SUBFOLDERS */}
//       {/* <div>
//         <h2 className="text-xl font-semibold text-gray-800 mb-3">Subfolders</h2>

//         {subfolders.length === 0 ? (
//           <p className="text-gray-500">No subfolders here.</p>
//         ) : (
...
//             {/* {user.role === "admin" && (
//               <label className="flex items-center gap-2 mt-2 pl-2">
//                 <input
//                   type="checkbox"
//                   checked={doc.can_download}
//                   onChange={() =>
//                     handleToggleDownload(doc.id, !doc.can_download)
//                   }
//                 />
...
//             {/* {user.role === "admin" && (
//   <label className="flex items-center gap-2 mt-2 pl-2 cursor-pointer">
...
//       checked={doc.can_download}
//       onChange={() => handleToggleDownload(doc.id, !doc.can_download)}
//       className="h-5 w-5 accent-orange-500 cursor-pointer transition-all duration-300"
//     />
//     <span className="text-sm font-bold text-orange-600 tracking-wide">
//       Allow Download
//     </span>
...
//         onClose={() => {
//           setViewFile(null);
//           loadData(); // 🔁 refresh statuses after approve/reject
//         }}
//       />
//     )}
...
//       {/* HEADER */}
//       <div className="flex justify-between items-center bg-gradient-to-r from-slate-50 to-blue-50 rounded-2xl p-6 border border-gray-300 shadow-sm">
//         <div>
...
//         {/* Documents Grid with Custom Scrollbar */}
//         <div
//           ref={scrollRef}
//           className="
//             overflow-y-auto
//             max-h-[calc(80vh-250px)]
//             p-2
//             mt-16
//             scroll-appear
//           "
...
const loadBreadcrumbData = async () => {
  try {
    ...
    if (user.role === "admin" && project.company_id) {
