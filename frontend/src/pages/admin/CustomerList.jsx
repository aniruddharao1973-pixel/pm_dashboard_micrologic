...
//                             {/* Avatar */}
//                             <div
//                               className="w-11 h-11 rounded-xl bg-gradient-to-br from-purple-500 via-indigo-500 to-blue-600
...
//                               onClick={() =>
//                                 navigate(
//                                   `/admin/edit-customer/${company.company_id}`
//                                 )
//                               }
//                               className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg
...
//                     <div
//                       className="w-9 h-9 sm:w-10 sm:h-10 md:w-11 md:h-11 rounded-lg sm:rounded-xl bg-gradient-to-br from-purple-500 via-indigo-500 to-blue-600
...
//                     Created:{" "}
//                     {new Date(company.users[0]?.created_at).toLocaleDateString(
//                       "en-US",
//                       {
//                         month: "short",
//                         day: "numeric",
